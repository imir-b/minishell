...
/*   Updated: 2026/05/08 01:32:44 by vbleskin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_ascii(void)
{
	...
	printf("\033[33m       | | | |  | |  __| |  __|  "
		"\\___ \\|  __  |  __| | |    | |\033[0m\n");
	printf("\033[33m       | | | |__| | |    | |     "
		"____) | |  | | |____| |____| |____\033[0m\n");
	printf("\033[33m       |_|  \\____/|_|    |_|    "
		"|_____/|_|  |_|______|______|______|\033[0m\n");
	printf("\033[31m  .                               "
		"                                       *\033[0m\n");
	printf("\033[31m        * ☭             "
		".             ☭              *\033[0m\n\n");
